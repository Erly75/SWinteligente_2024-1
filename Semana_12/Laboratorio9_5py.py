...
# imagen = cv2.imread("1a.jpg") ##leemos la imagen con la que trabajaremos y la guardamos en la variable imagen
...
# =============================================================================
# Usando iterpolaciones metodos de la libreria OPENCV
# =============================================================================
# #Metodo 2

imagen = cv2.imread('1a.jpg') ##Leemos la imagen a escalar y guardarla en la variable imagen
